...
public abstract class NotificationMapper {
    ...
    @Mapping(target = "notificationType", expression = "java(java.util.Arrays.stream(com.babylonradio.notification_service.publicnotification.enums.NotificationType.values()).map(com.babylonradio.notification_service.publicnotification.enums.NotificationType::toString).toList().contains(queryDocumentSnapshot.getData().get(\"type\")) ? com.babylonradio.notification_service.publicnotification.enums.NotificationType.valueOf(queryDocumentSnapshot.getData().get(\"type\").toString()) : com.babylonradio.notification_service.publicnotification.enums.NotificationType.NOT_RECOGNIZED)")
    ...
    @Mapping(target = "notificationType", expression = "java(isGroupChat ? com.babylonradio.notification_service.publicnotification.enums.NotificationType.GROUPCHAT_MESSAGE : com.babylonradio.notification_service.publicnotification.enums.NotificationType.CHAT_MESSAGE)")
